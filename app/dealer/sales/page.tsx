...
interface CostItem {
  ...
  usd: number
  brl: number
  type: "boat_model" | "engine_package" | "hull_color" | "additional_option"
}
...
export default function SalesPage() {
  ...
  const [activeTab, setActiveTab] = useState<"boat_model" | "engine_package" | "hull_color" | "additional_option">(
    "boat_model",
  )
  ...
  const translations = {
    ...
    es: {
      ...
      Cancel: "Cancelar",
      "Loading...": "Cargando...",
      "No hay artículos configurados": "No hay artículos configurados",
  ...
  const getPricingForItem = (itemId: number, itemType: string) => {
    ...
    return pricingItems.find((p) => p.item_id === itemId && p.item_type === itemType && p.dealer_id === dealerId)
  }
